...
base_path = "C:/Users/vegetabledog/Desktop/逃票检测截至20200622日志/181/"
f_dest = open("C:/Users/vegetabledog/Desktop/181.txt", 'w', encoding="utf-8")
    ...
    if file.__contains__("error") is False:
        ...
        with open(filepath, encoding='utf-8') as fo:
            for line in fo.readlines():
                ...
                time_str = line[0: 23]
                if time_str not in time_str_list:    # 避免重复数据
                        ...
                        if len(dict["person_details_list"]) > 0:
                            ...
                            for detail in dict["person_details_list"]:
                                ...
                                if detail["brake_num"] == "None":
                                    detail["brake_num"] = "0"
                                print(str(time_str), str(day), str(hours), dict["savefile"], dict["read_time"],
                                      dict["detect_time"],
